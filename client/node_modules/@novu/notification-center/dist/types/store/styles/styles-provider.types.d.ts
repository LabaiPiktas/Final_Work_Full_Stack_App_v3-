...
export declare type StylesPaths = 'bellButton.root' | 'bellButton.dot' | 'popover.arrow' | 'popover.dropdown' | 'loader.root' | 'layout.root' | 'header.root' | 'header.title' | 'header.markAsRead' | 'header.cog' | 'header.backButton' | 'tabs.tabsList' | 'tabs.tab' | 'tabs.tabLabel' | 'tabs.tabIcon' | 'accordion.item' | 'accordion.content' | 'accordion.control' | 'accordion.chevron' | 'switch.root' | 'switch.input' | 'switch.track' | 'switch.thumb' | 'unseenBadge.root' | 'footer.root' | 'footer.title' | 'notifications.root' | 'notifications.listItem.read' | 'notifications.listItem.unread' | 'notifications.listItem.layout' | 'notifications.listItem.contentLayout' | 'notifications.listItem.title' | 'notifications.listItem.timestamp' | 'notifications.listItem.buttons.root' | 'notifications.listItem.buttons.primary' | 'notifications.listItem.buttons.secondary' | 'preferences.root' | 'preferences.item.title' | 'preferences.item.channels' | 'preferences.item.divider' | 'preferences.item.content.icon' | 'preferences.item.content.channelLabel' | 'preferences.item.content.success';
